...
RV free wall akinesis with preserved or hyperdynamic apical motion. Highly specific for acute PE (specificity ~94%). The mechanism involves tethering of the RV apex to the contracting LV. In the right clinical context (tachycardia, hypoxia, plethoric IVC), McConnell's sign is enough to initiate PE workup and consider empiric thrombolytics in an unstable patient.
...
TAPSE (tricuspid annular plane systolic excursion) below 17 mm indicates RV systolic dysfunction. Measured by M-mode on the RV-focused A4C with the cursor aligned through the lateral tricuspid annulus. It reflects longitudinal RV function and correlates with prognosis across PE, pulmonary hypertension, and right heart failure. TAPSE is load-dependent — serial measurements track RV recovery in response to treatment.
...
- **Cautious fluid loading** to maintain RV preload — unlike LV infarction, where fluid restriction may be necessary.
- **Avoid nitrates and diuretics** — both reduce preload and can precipitate hemodynamic collapse in isolated RV infarction.
