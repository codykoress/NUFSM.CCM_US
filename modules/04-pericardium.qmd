...
::: {.callout-tip}
PLAX for pericardial assessment — posterior effusion, descending aorta landmark, effusion sizing.
...
::: {.callout-tip}
Normal pericardium in each window. Normal mitral inflow Doppler. Normal hepatic vein flow.
...
::: {.callout-tip}
Large circumferential effusion — swinging heart, echo-free space in all windows.
...
::: {.callout-tip}
Post-operative loculated effusion — anterior, irregular, compressing a single chamber.
